...
export type PublicInvitePageConfig = {
  ...
  navInitials?: string;
  /** URL da imagem de logo/monograma no nav. Se preenchida, substitui o ícone SVG e o texto de iniciais. */
  navLogoUrl?: string;
...
export const DEFAULT_BOTANICO_PAGE_CONFIG = {
  ...
  navInitials: "R & M",
  navLogoUrl: "/api/uploads/users/1/casamento-rodrigo-e-millena-w3/gifts/Monograma.png",
